  ...
  return (
    <div className="grid grid-cols-[60%,39%] max-sm:flex max-sm:flex-col gap-5 max-sm:mb-[750px] bg-[#111621] w-full mt-[70px] px-28 max-sm:px-5 py-28 max-sm:py-14 relative">
      ...
      <div className="flex flex-col gap-2 relative z-[1]">
        ...
        <h1 className="text-5xl max-sm:text-4xl text-white font-bold leading-[58px] max-sm:leading-[45px]">
          Data Science & AI Bootcamp For Professionals
        </h1>
        <p className="text-[#cccccc] w-[91%] max-sm:w-[97%] text-[18px] max-sm:text-[14px] leading-[28px] max-sm:leading-[24px] font-light mt-2">
      ...
      <div className="flex flex-col gap-7 relative">
        <div className="bg-white px-11 py-3 max-sm:px-0 rounded shadow flex flex-col w-full z-[1] absolute mt-28">
          <div className="absolute w-[451px] max-sm:w-[330px] h-[288px] max-sm:h-[202px] top-[-120px] max-sm:top-[-100px] left-7 max-sm:left-2 max-sm:flex max-sm:justify-center">
            <Image
